<header class="py-4 bg-white">
    ...
    <nav class="py-4">
            <div class="container mx-auto px-4 flex items-center justify-between">
                ...
                <button
                    class="bg-gray-400 hover:bg-gray-500 text-white font-bold py-2 px-4 mr-3 rounded focus:outline-none focus:shadow-outline"
                    type="button">
                    Каталог
                </button>
                <form class="flex items-center w-full">
                        <input
                            class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-l py-2 px-4 block w-full appearance-none leading-normal"
